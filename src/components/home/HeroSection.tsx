...
export function HeroSection({ prompt, setPrompt }: HeroSectionProps) {
    ...
    return (
        <header className="relative z-10 px-6 py-24 md:pt-25 pt-20 md:mb-20">
            <div className="max-w-5xl mx-auto text-center">
                ...
                >
                    ...
                    <p className="text-base font-normal text-gray-400 max-w-2xl mx-auto">
                        ...
                        <span className="text-blue-400 font-semibold"> SnapSite</span>
                    </p>
                </motion.div>
                ...
                >
                    <div className="backdrop-blur-md bg-gray-900/50 rounded-xl shadow-2xl border border-gray-800/80 overflow-hidden">
                        <Textarea
                            ...
                            className="scroll w-full h-32 p-5 bg-transparent text-gray-100 rounded-lg focus:outline-none resize-none placeholder-gray-500"
